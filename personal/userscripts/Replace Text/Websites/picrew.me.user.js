...
// @updateURL    https://eugenekoh12.github.io/personal/userscripts/Replace%20Text/Websites/picrew.me.meta.js
// @downloadURL  https://eugenekoh12.github.io/personal/userscripts/Replace%20Text/Websites/picrew.me.user.js
    ...
    */}
    ...
    if (runScript) {
        ...
        let replaceRules = [
            ...
            [/商用/i, "Commercial Use"],
            [/加工/i, "Redistribution Allowed"],
            [/男の子/i, "Male"],
            [/完成しました！/i, "Completed Image!"],
            [/完成/i, "Finalize"],
            [/画像ダウンロード/i, "Download Image"],
            [/ランダムPickup/i, "Random Pickup"],
            [/もっと見る/i, "See More"],
            [/Picrewとは？/i, "What is Picrew?"],
            [/Picrewクリエイターへ/i, "Picrew Creator"],
            [/Picrewクリエイター/i, "Picrew Creator"],
            [/公式Twitter/i, "Official Twitter"],
            [/ディスカバリー/i, "Discovery"],
            [/HOTなメーカー/i, "HOT Picrews"],
            [/更新されたメーカー/i, "Updated Picrews"],
            [/Picrewについて/i, "About Picrew"],
            [/Picrewであそぶ/i, "Create with Picrew"],
