    ...
    */}
    ...
    if (runScript) {
        ...
        let replaceRules = [
            ...
            [/workaholic little panda/i, "workaholic little red panda"],
            [/the little panda asked his bad friend/i, "the little red panda asked his bad friend"],
            [/The little panda mumbled/i, "The little red panda mumbled"],
            [/The little panda was holding a heart/i, "The little red panda was holding a heart"],
            [/The purple horse glanced at the little panda/i, "The purple horse glanced at the little red panda"],
            [/The little panda was not being mean this time/i, "The little red panda was not being mean this time"],
            [/The little panda was full of question marks/i, "The little red panda was full of question marks"],
            [/pushing the little panda who was/i, "pushing the little red panda who was"],
            [/The little panda who was in the way kicked it away/i, "The little red panda who was in the way was kicked away"],
            [/The little panda that was kicked aside/i, "The little red panda that was kicked aside"],
            [/The little panda was angry/i, "The little red panda was angry"],
            [/Little panda\: “…Go.”/i, "Little red panda: “…Go.”"],
            [/and glanced at the aggrieved little panda/i, "and glanced at the aggrieved little red panda"],
            [/the ghost is a little panda/i, "the ghost is a little red panda"],
            [/The little panda said with his little paw/i, "The little red panda said with his little paw"],
            [/All the fluffy subordinates applauded the brave little panda one after another/i, "All the fluffy subordinates applauded the brave little red panda one after another"],
            [/The little panda proudly raised his belly/i, "The little red panda proudly raised his belly"],
            [/Little Panda\: “…”/i, "Little Red Panda: “…”"],
            [/Little Panda Huo/i, "Little Red Panda Huo"],
